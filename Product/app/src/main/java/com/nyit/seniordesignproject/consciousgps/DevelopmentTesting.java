...
//            if (buttonCounter >= 5) {
//                 buttonCounter = 0;
//                startActivity(new Intent(getApplicationContext(), DevelopmentTesting.class));
//            }
//        });
//
//    }
...
public class DevelopmentTesting extends AppCompatActivity {
 /*   //private static final String CLOUD_VISION_API_KEY = BuildConfig.Cloud_Vision_API_KEY;
    ...
    private final String LOG_TAG = "DevelopmentTesting";
    Account mAccount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button selectImageButton = findViewById(R.id
                .select_image_button);
        ...
        selectImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCompat.requestPermissions(DevelopmentTesting.this,
        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(DevelopmentTesting.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    private void getAuthToken() {
        ...
        if (mAccount == null) {
            ...
            new GetTokenTask(DevelopmentTesting.this, mAccount, SCOPE, REQUEST_ACCOUNT_AUTHORIZATION)
                    .execute();
        }
    }
