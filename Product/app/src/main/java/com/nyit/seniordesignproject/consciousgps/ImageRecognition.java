...
/*
 * Copyright 2019 New York Institute of Technology Senior Design All Rights Reserved.
 *
...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.image_recognition_main);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        FloatingActionButton fab = findViewById(R.id.fab);
        fab.setOnClickListener(view -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(ImageRecognition.this);
            builder
...
//                    add(textDetection);
    ...
    private static class LabelDetectionTask extends AsyncTask<Object, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ImageRecognition activity = mActivityWeakReference.get();
